...
if(submit!=null){
	...
	if(password.equals(retypepassword)){
		...
		try {
			...
			String sql = "INSERT INTO users (username, password, first_name, last_name, email, birth_date, user_type) VALUES( '" + username + "', '" + password + "', '" + 
			firstname + "', '" + lastname + "', '" + email + "', '" + birthdate + "', '" + usertype + "' ) ";
